...
namespace BankomatSimulator
{
    ...
    class InterfacciaUtente
    {
        ...
        private int SchermataDiBenvenuto(Bankomat2Entities ctx)
        {
            int scelta = -1;
            while (scelta == -1)
            {
        ...
        //        {
        //            if (cust.NomeUtente == username && cust.Password == password)
        //            {
        ...
        private bool Login(Bankomat2Entities ctx)
        {
            ...
            Banca.EsitoLogin esitoLogin =
                _bancaCorrente.Login(credenziali, out Utente utente, ctx);
        ...
        ///</summary>
        public void Esegui(Bankomat2Entities ctx)
        {
